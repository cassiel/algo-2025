...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "float" ],
									"patching_rect" : [ 422.0, 183.0, 59.0, 22.0 ],
									"text" : "* 1000."
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 392.0, 148.0, 95.0, 22.0 ],
									"text" : "unpack 0. 0."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "bang" ],
									"patching_rect" : [ 392.0, 218.0, 41.0, 22.0 ],
									"text" : "line 0."
								}
...
, 							{
								"box" : 								{
									...
									"parameter_enable" : 1,
									"patching_rect" : [ 20.0, 20.0, 61.0, 124.0 ],
...
,
					"patching_rect" : [ 450.0, 565.0, 60.0, 135.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 150.0, 85.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 255.0, 210.0, 85.0, 23.0 ],
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 195.0, 45.0, 32.0, 30.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 165.0, 45.0, 32.0, 30.0 ],
					"triangle" : 0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 465.0, 10.0, 31.0, 23.0 ],
					"text" : "- 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 300.0, 45.0, 105.0, 25.0 ],
					"saved_attribute_attributes" : 					{
						"activebgcolor" : 						{
							"expression" : ""
						}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 525.0, 40.0, 92.0, 23.0 ],
					"text" : "mc.adc~ 3 3"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 50.0, 100.0, 303.0, 56.0 ],
									"text" : "setdirection up, setalignment right, setsize 6, clear, append IO, append Basic, append Enso, append Mini-Filter, append Replika_XT, append Axon"
								}
...
,
					"patching_rect" : [ 225.0, 375.0, 30.0, 23.0 ],
...
, 			{
				"box" : 				{
					"embedstate" : [ [ "setdirection", "up" ], [ "setalignment", "right" ], [ "setfont", "Monaco", 9 ], [ "nativeFRGB", 0, 0, 0 ], [ "nativeBRGB", 1, 1, 1 ] ],
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 390.0, 465.0, 225.0, 75.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 225.0, 45.0, 79.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 270.0, 15.0, 85.0, 23.0 ],
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 390.0, 245.0, 225.0, 220.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 435.0, 70.0, 60.0, 90.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 360.0, 480.0, 32.0, 23.0 ],
									"text" : "1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 360.0, 405.0, 85.0, 23.0 ],
									"text" : "route done"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 90.0, 170.0, 33.0, 23.0 ],
									"text" : "int"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 120.0, 115.0, 32.0, 23.0 ],
									"text" : "0"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 45.0, 110.0, 39.0, 32.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 180.0, 115.0, 53.0, 23.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "" ],
									"patching_rect" : [ 45.0, 65.0, 47.0, 23.0 ],
									"text" : "sel 1"
								}
...
,
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 30.0, 200.0, 390.0, 175.0 ],
									"pitchcorrection" : 0,
									"quality" : "basic",
									"timestretch" : [ 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 120.0, 400.0, 174.0, 35.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "multichannelsignal" ],
									"patching_rect" : [ 30.0, 415.0, 85.0, 23.0 ],
									"text" : "mc.pack~ 2"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 0 ],
									"midpoints" : [ 369.5, 510.0, 469.0, 510.0, 469.0, 99.0, 54.5, 99.0 ],
									"source" : [ "obj-19", 0 ]
								}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 450.0, 215.0, 176.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 525.0, 70.0, 60.0, 90.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 120.0, 385.0, 92.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 120.0, 360.0, 47.0, 23.0 ],
					"text" : "front"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 120.0, 330.0, 47.0, 23.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 450.0, 720.0, 45.0, 45.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 540.0, 320.0, 176.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 420.0, 106.0, 173.0, 21.0 ],
									"style" : "c.comment",
									"text" : "Token \"empty\" VST"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 420.0, 130.0, 215.0, 23.0 ],
									"text" : "plug_vst \"studiomux effect\""
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 420.0, 170.0, 108.0, 23.0 ],
									"text" : "plug_vst Enso"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "route audio Basic Enso Mini-Filter Replika_XT Axon"
								}
...
, 							{
								"box" : 								{
									...
									"text" : "route mix Basic Enso Mini-Filter Replika_XT Axon"
								}
...
,
					"patching_rect" : [ 225.0, 305.0, 62.0, 23.0 ],
					"saved_object_attributes" : 					{
						"bgcolor" : [ 0.163647, 0.174699, 0.17409, 1.0 ],
						"description" : "",
						"digest" : "",
...
,
					"patching_rect" : [ 60.0, 275.0, 92.0, 23.0 ],
					"saved_object_attributes" : 					{
						"bgcolor" : [ 0.163647, 0.174699, 0.17409, 1.0 ],
						"description" : "",
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 410.0, 360.0, 125.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 15.0, 545.0, 400.0, 220.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 256.0, 348.0, 349.5, 348.0, 349.5, 134.0, 24.5, 134.0 ],
					"source" : [ "obj-13", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 0.720698, 0.16723, 0.080014, 1.0 ],
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 69.5, 360.5, 363.5, 360.5, 363.5, 122.0, 24.5, 122.0 ],
					"source" : [ "obj-4", 0 ]
				}
