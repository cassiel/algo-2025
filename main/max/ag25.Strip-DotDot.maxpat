...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 20.0, 158.0, 50.0 ],
					"style" : "c.comment",
					"text" : "Turn A..B into A:B - the inverse happens in Clojure."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 60.0, 95.0, 306.0, 23.0 ],
