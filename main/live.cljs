...
#_ (ctrl/unload-all [:Basic :Enso :Mini-Filter :Replika_XT])
...
;; #1
(swap! SEQ assoc-in [:sequences :mf] {1 [[0 :Mini-Filter :param :Cutoff 0.4]]
                                      2 [[0 :Mini-Filter :param :Cutoff 0.6]
                                         [0.5 :Mini-Filter :param :Cutoff 0.7]]
                                      3 [[0 :Mini-Filter :param :Cutoff 0.0]]
                                      4 [[0 :Mini-Filter :param :Cutoff 0.5]
                                         [0.5 :Mini-Filter :param :Cutoff 0.8]]})

;; #2
(swap! SEQ assoc-in [:sequences :mf] {1 [[0 :Mini-Filter :param :Cutoff 0.3]]
                                      2 [[0 :Mini-Filter :param :Cutoff 0.7]
                                         [0.5 :Mini-Filter :param :Cutoff 0.5]]
                                      3 [[0 :Mini-Filter :param :Cutoff 0.0]]
...
(do
  ...
  (ctrl/mix :Replika_XT :Mini-Filter 0 10)
  (ctrl/mix :Mini-Filter :IO 6 10))
...
(px/xmit-some-params-now :Mini-Filter [:Resonance 0.6])
...
;; ----- SYNTH -> FILTER -----
(ctrl/mix :Basic :Mini-Filter -6 5)
